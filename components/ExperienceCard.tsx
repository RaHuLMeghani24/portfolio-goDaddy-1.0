...
export default function ExperienceCard({ experience }: Props) {
  return (
    <article
      className=" flex flex-col rounded-sm items-center space-y-7 flex-shrink-0  w-[200px]  md:w-[600px] xl:w-[900px] 
    ...
    >
      ...
      <div className="px-0 md:px-10">
        ...
        scrollbar-none scrollbar-track-black scrollbar-thumb-[#F7AB0A]/80"
        >
