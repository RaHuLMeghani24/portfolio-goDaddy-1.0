...
export default function ContactMe({}: Props) {
  ...
  const onSubmit: SubmitHandler<Inputs> = (formData) => {
    window.location.href = `mailto:rahulmeghani36@gmail.com?subject=${formData.subject}&body=Hi, my name is ${formData.name}.${formData.message}`;
    //console.log(formData);
  };

  return (
    <div className="h-screen flex relative flex-col text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center">
      <h3 className="absolute top-0 md:top-2 uppercase tracking-[20px] text-gray-500 text-xl md:text-2xl">
        Contact
      </h3>
      <div className="flex flex-col space-y-4 md:space-y-5 lg:space-y-6 xl:space-y-6 2xl:space-y-10">
        ...
        <div className="space-y-1 md:space-y-3 lg:space-y-3 xl:space-y-3 2xl:space-y-5">
          <div className="flex items-center space-x-5 justify-center">
            ...
            <p className="text-lg md:text-2xl lg:text-2xl">+1 (226) 724-1895</p>
          </div>
          <div className="flex items-center space-x-5 justify-center">
          ...
          <div className="flex items-center space-x-5 justify-center">
            ...
            <p className="text-lg md:text-2xl lg:text-2xl">Windsor, Canada</p>
          </div>
        </div>
        ...
        >
          ...
          <textarea
            ...
            className="contactInput"
          />
          <button className="bg-amber-400 py-3 md:py-5 px-10 rounded-lg text-white font-bold text-lg">
            {" "}
            Submit
          </button>
        </form>
